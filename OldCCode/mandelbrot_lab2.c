...
// The thread 2 function will be in charge of checking to see if anything was typed into 
// the terminal and if so, parse the result and send the appropriate commands to the 
// 

	Computer_System u0 (
		...
		.pio_dx_c_external_connection_1_export         (<connected-to-pio_dx_c_external_connection_1_export>),         //         pio_dx_c_external_connection_1.export
		.pio_dy_c_external_connection_2_export         (<connected-to-pio_dy_c_external_connection_2_export>),         //         pio_dy_c_external_connection_2.export
		.pio_in_done_external_connection_export        (<connected-to-pio_in_done_external_connection_export>),        //        pio_in_done_external_connection.export
		.pio_mandel_timer_external_connection_export   (<connected-to-pio_mandel_timer_external_connection_export>),   //   pio_mandel_timer_external_connection.export
		.pio_max_iterations_external_connection_export (<connected-to-pio_max_iterations_external_connection_export>), // pio_max_iterations_external_connection.export
		...
		.pio_zoom_num_external_connection_export       (<connected-to-pio_zoom_num_external_connection_export>),       //       pio_zoom_num_external_connection.export
